...
if "release" in sys.argv[-1]:
    ...
    os.system("rm -rf dist/portfolio_optimization*")
    sys.exit()
...
ext_modules = [
    Extension(
        "portfolio_optimization.optimization.risk_parity_impl.vanilla",
        ["portfolio_optimization/optimization/risk_parity_impl/vanilla.cpp"],
        include_dirs=[
...
setup(
    ...
    version=__version__,
    author="Arthur Guiot",
    author_email="arthur.g@pr1mer.tech",
    url="https://every.finance",
    description="Portfolio optimization Benchmarking",
    license="MIT",
    package_dir={"portfolio_optimization": "portfolio_optimization"},
